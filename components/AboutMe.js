export default function AboutMe() {
  return (
    <div className="h-screen flex flex-col text-center justify-center items-center gap-4 p-2">
      <div className="text-3xl text-bold font-mono">A B O U T</div>
      ...
      <p>I am in the process of creating <a href="https://github.com/JeffLi117/Not-In-Vein">Not In Vein</a>, a centralized reminder application to help remind donors to keep giving back to others.</p>
