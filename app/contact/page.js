    ...
    return (
        <section className="relative mx-4 h-full pb-8">
            ...
            <div className={`flex flex-col justify-start items-start gap-4 p-2`}>
                ...
                <div className="mb-4">If you'd like to chat about a project, need help with a product, or just have a question, please fill out the form below. I'll get back to you as soon as I can!</div>
                <EmailMeForm />
            </div>
        </section>
