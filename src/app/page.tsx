  ...
  return (
    <div className="min-h-screen bg-[#12001a]">
      ...
      <section id="home" className="min-h-screen flex flex-col justify-center items-center py-24">
        ...
        <span className="text-xl sm:text-2xl md:text-3xl text-purple-400 text-center">
          <TypeAnimation
            sequence={[
      ...
      <section id="about" className="min-h-screen flex flex-col justify-center items-center py-24 bg-gradient-to-br from-purple-900/80 via-black/80 to-purple-950/90">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          <img
            ...
            className="w-40 sm:w-52 md:w-72 rounded-full border-4 border-purple-700 shadow-lg shadow-purple-900"
          />

          <div className="max-w-2xl text-base md:text-lg text-purple-100 text-center space-y-4 bg-black/30 rounded-lg p-6 mx-4">
